        ...
        for attack in attacks:
            ...
            if attack.is_attacker_enemy:
                if not self.grid.enemy_base:
                    if self.previous_position and defender_pos == self.previous_position and (self.grid.manhattan(defender_pos, attacker_pos) > 4 or not self.grid[attacker_pos].enemy_soldiers):
                        # ENEMY BASE IS FOUND!
